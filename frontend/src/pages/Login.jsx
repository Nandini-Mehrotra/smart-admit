        ...
        <div className="bg-white dark:bg-slate-800 py-8 px-10 shadow-xl shadow-gray-200/50 dark:shadow-none sm:rounded-2xl border border-gray-100 dark:border-slate-700 transition-colors duration-300">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center py-3 px-4 mt-2 rounded-lg text-sm font-bold text-gray-900 dark:text-white bg-white dark:bg-slate-800 border-2 border-gray-200 dark:border-slate-600 hover:border-gray-900 dark:hover:border-slate-500 hover:bg-gray-50 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 dark:focus:ring-slate-500 dark:focus:ring-offset-slate-900 disabled:opacity-50 transition-all shadow-sm"
            >
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 dark:border-slate-700 text-center text-sm transition-colors duration-300">
            <span className="text-gray-500 dark:text-slate-400">New to Smart Admit? </span>
            <Link to="/signup" className="font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
              Sign up for free
            </Link>
          </div>
        </div>
